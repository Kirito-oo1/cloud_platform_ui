<template>
  <app-view-layout :title="'Multistitcher'" style="margin-left: 100px">
    ...
    <div>
      ...
      <div v-if="$store.getters['settings/multiStitcherSettingsOn']">
        <el-tabs v-model="activeTabIndexMultiStitcher" :style="{ height: '30px' }" @tab-click="handleTabChange">
...
<script>
  ...
  import MultiStitcherCameraSettings from "./settings/MultiStitcherCameraSettings";
