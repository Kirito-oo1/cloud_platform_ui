import { Settings } from "@/views/HomeView/main/systemFunction/pictureMerge/models/Settings";
...
export class WorkerResult {
  constructor(name, imageDataToUrlFn) {
    ...
    if (imageDataToUrlFn == null || !typeof imageDataToUrlFn == "function") {
  ...
  get imageDataValid() {
    return this._imageData && this._imageData.width > 0 && this._imageData.height > 0;
  }
  get success() {
